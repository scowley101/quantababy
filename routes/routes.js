...
function setupRoutes(tableName, routePath) {
  ...
  router.get(`/${routePath}/`, crudInstance.find(), (req, res) => res.jsonp(req.result));
  router.get(`/${routePath}/new`, (req, res) => res.render('new'));
  router.post(`/${routePath}/new`, crudInstance.create(), (req, res) => res.jsonp(req.result));
  router.get(`/${routePath}/:id`, crudInstance.findOne(), (req, res) => res.jsonp(req.result));
  router.put(`/${routePath}/:id`, crudInstance.update(), (req, res) => res.jsonp(req.result));
}
